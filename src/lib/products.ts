...
export const products: Product[] = [
  {
    ...
    price: 14500, compareAt: 19000, colors: [{name:"Navy",hex:"#1a2540"},{name:"Black",hex:"#111"}], sizes, image: navyEveningDress, gradient: C.navy, badge: "best", tags: ["dress","evening"]
  },
  {
    ...
    price: 12500, colors: [{name:"Beige",hex:"#d9c2a3"},{name:"Ivory",hex:"#f0e6d2"}], sizes, image: beigeAbaya, gradient: C.beige, badge: "new", tags: ["abaya"]
  },
  {
    ...
    price: 6500, colors: [{name:"Blush",hex:"#f7c6d3"},{name:"Ivory",hex:"#f0e6d2"}], sizes, image: pinkBlouse, gradient: C.blush, tags: ["top","silk"]
  },
  {
    ...
    price: 18500, colors: [{name:"Camel",hex:"#c39a6b"},{name:"Black",hex:"#111"}], sizes: oneSize, image: leatherHandbag, gradient: C.champagne, badge: "best", tags: ["bag"]
  },
  {
    ...
    price: 4400, colors: [{name:"Pearl",hex:"#f0e6e8"}], sizes: oneSize, image: pearlEarrings, gradient: C.pearl, tags: ["jewelry"]
  },
  {
    ...
    price: 10500, compareAt: 13500, colors: [{name:"Burgundy",hex:"#6b2438"},{name:"Black",hex:"#111"}], sizes: shoeSizes, image: burgundyHeels, gradient: C.burgundy, badge: "offer", tags: ["shoes"]
  },
  {
    ...
    price: 7500, colors: [{name:"Ivory",hex:"#f0e6d2"},{name:"Sage",hex:"#a9b89a"}], sizes, image: linenKaftan, gradient: C.sage, badge: "new", tags: ["kaftan"]
  },
  {
    ...
    price: 5400, colors: [{name:"Gold",hex:"#c9a24e"}], sizes: oneSize, image: goldNecklace, gradient: C.gold, tags: ["jewelry"]
  },
  {
    ...
    price: 24500, colors: [{name:"Ivory",hex:"#f0e6d2"},{name:"Camel",hex:"#c39a6b"}], sizes, image: ivoryCoat, gradient: C.ivory, tags: ["coat"]
  },
  {
    ...
    price: 21500, compareAt: 28000, colors: [{name:"Blush",hex:"#f7c6d3"},{name:"Champagne",hex:"#cdb38a"}], sizes, image: farhaDress, gradient: C.rose, badge: "best", tags: ["dress","evening"]
  },
  {
    ...
    price: 17800, colors: [{name:"Emerald",hex:"#1f3d34"}], sizes, image: emeraldGown, gradient: C.emerald, badge: "new", tags: ["dress"]
  },
  {
    ...
    price: 9900, compareAt: 12600, colors: [{name:"Pearl",hex:"#f0e6e8"},{name:"Black",hex:"#111"}], sizes: oneSize, image: crystalClutch, gradient: C.pearl, badge: "offer", tags: ["bag","accessory"]
  },
  {
    ...
    price: 2900, colors: [{name:"Lilac",hex:"#c9a9d6"},{name:"Blush",hex:"#f7c6d3"}], sizes: oneSize, image: lilacScarf, gradient: C.lilac, tags: ["accessory"]
  },
  {
    ...
    price: 16200, colors: [{name:"Black",hex:"#111"},{name:"Burgundy",hex:"#6b2438"}], sizes, image: noirBlazer, gradient: C.black, badge: "new", tags: ["blazer"]
  },
  {
    ...
    price: 11000, compareAt: 14000, colors: [{name:"Champagne",hex:"#cdb38a"},{name:"Blush",hex:"#f7c6d3"}], sizes, image: champagneSlip, gradient: C.champagne, badge: "offer", tags: ["dress"]
  },
];
